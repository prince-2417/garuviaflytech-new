...
<!-- Mirrored from html.webtend.net/oxence/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jul 2026 16:29:32 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <!-- Title -->
    <title>Oxence - Web Design Company HTML Template || 404 Error</title>
    <!-- Favicon Icon -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="error-content rmb-75 wow fadeInLeft delay-0-2s">
                            <div class="logo mb-40">
                                <a href="index.html"><img src="assets/images/logos/logo.png" alt=""></a>
                            </div>
                            <h1>OPPS!</h1>
                            ...
                            <a href="index.html" class="theme-btn style-two mt-15 mb-50">Go to Home <i class="fas fa-angle-double-right"></i></a>
                            <div class="follow-us">
                                <h4>Follow Us</h4>
                    ...
                    <div class="col-lg-7">
                        <div class="error-image wow fadeInRight delay-0-2s">
                            <img src="assets/images/background/404.html" alt="404 Error">
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from html.webtend.net/oxence/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jul 2026 16:29:33 GMT -->
</html>
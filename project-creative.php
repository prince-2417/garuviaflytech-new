...
<!-- Mirrored from html.webtend.net/oxence/project-creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jul 2026 16:29:20 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <!-- Title -->
    <title>Oxence - Web Design Company HTML Template || Project Creative</title>
    <!-- Favicon Icon -->
        ...
        <section class="page-banner-area pt-245 rpt-150 pb-170 rpb-100 rel z-1 bgc-lighter text-center">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h1 class="page-title wow fadeInUp delay-0-2s">Project Cre<span>ative</span></h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center wow fadeInUp delay-0-4s">
                            <li class="breadcrumb-item"><a href="index.html">home</a></li>
                            <li class="breadcrumb-item active">Project Creative</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="container">
                <div class="project-creative-item">
                    <div class="image wow fadeInLeft delay-0-2s">
                        <img src="assets/images/projects/project-three1.jpg" alt="Project Creative">
                    </div>
                    <div class="content wow fadeInRight delay-0-2s">
                        ...
                        <hr>
                        <p>Start from scratch or choose over 500 designer made template that you can customize usinghe drag and drop website buildersite</p>
                        <a href="project-details.html" class="theme-btn style-three">Project Details <i class="fas fa-angle-double-right"></i></a>
                    </div>
                </div>
                <div class="project-creative-item">
                    <div class="content wow fadeInRight delay-0-2s">
                ...
                <div class="project-creative-item">
                    ...
                    <div class="content wow fadeInRight delay-0-2s">
                        <div class="section-title">
                            <span class="sub-title style-two mb-15">03</span>
                ...
                <div class="project-creative-item">
                    <div class="content wow fadeInRight delay-0-2s">
                        <div class="section-title">
                            <span class="sub-title style-two mb-15">04</span>
                            <h2>Web Template</h2>
                        </div>
                        <hr>
                        <p>Start from scratch or choose over 500 designer made template that you can customize usinghe drag and drop website buildersite</p>
                ...
                <div class="project-creative-item">
                    ...
                    <div class="content wow fadeInRight delay-0-2s">
                        <div class="section-title">
                            <span class="sub-title style-two mb-15">05</span>
                ...
                <div class="project-creative-item">
                    <div class="content wow fadeInRight delay-0-2s">
                        <div class="section-title">
                            <span class="sub-title style-two mb-15">06</span>
                            <h2>Saas Landing</h2>
                        </div>
                        <hr>
                        <p>Start from scratch or choose over 500 designer made template that you can customize usinghe drag and drop website buildersite</p>
...
<!-- Mirrored from html.webtend.net/oxence/project-creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jul 2026 16:29:22 GMT -->
</html>
...
<!-- Mirrored from html.webtend.net/oxence/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jul 2026 16:29:41 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    ...
    <!-- Title -->
    <title>Oxence - Web Design Company HTML Template || Blog List</title>
    <!-- Favicon Icon -->
        ...
        <section class="page-banner-area pt-245 rpt-150 pb-170 rpb-100 rel z-1 bgc-lighter text-center">
            <div class="container">
                <div class="banner-inner rpt-10">
                    <h1 class="page-title wow fadeInUp delay-0-2s">Blog List <span>View</span></h1>
        ...
        <section class="blog-list-area py-130 rel z-1">
            <div class="container">
                <div class="blog-list-item wow fadeInUp delay-0-2s">
                    <div class="image">
                        <img src="assets/images/blog/blog1.jpg" alt="Blog List">
                    </div>
                    <div class="blog-content">
                        <div class="content">
                            <ul class="blog-meta">
                                <li>
                                    <img src="assets/images/blog/blog1.jpg" alt="Author">
                            ...
                            <h4><a href="blog-details.html">How To Build Group Chat With Vanilla JS, Twilio Manage Accessible Design System</a></h4>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolore mquees laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architec to beatae vitae dicta sunt explicabo voluptatem quia voluptas site</p>
                ...
                <ul class="pagination flex-wrap justify-content-center pt-20 wow fadeInUp delay-0-2s">
...
<!-- Mirrored from html.webtend.net/oxence/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Jul 2026 16:29:43 GMT -->
</html>